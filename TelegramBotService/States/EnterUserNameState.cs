                ...
                new InlineKeyboardButton[][] {
                    new InlineKeyboardButton[]
                    {
                        new InlineKeyboardButton()
                        {
                             ...
                             CallbackData = "SendMessage_" + group.Id
                        }
                    ...
                    new InlineKeyboardButton[]
                    {
                        new InlineKeyboardButton()
                        {
                            ...
                            CallbackData = "CreateTopic_" + group.Id.ToString()
                        },
                    new InlineKeyboardButton()
                        {
                            Text = "\U00002699 Settings",
                            CallbackData = "GroupSettings_"+ group.Id.ToString()
                        }
                    },
                    new InlineKeyboardButton[]
                    {
